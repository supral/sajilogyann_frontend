      ...
      <div className="sg-modal-overlay" onClick={() => setPreviewCert(null)}>
        <div className="sg-modal" onClick={(e) => e.stopPropagation()}>
          <div className="sg-modal-top">
            ...
            <button type="button" className="btn-close" onClick={() => setPreviewCert(null)}>
              ✕
            </button>
          </div>

          <div className="sg-modal-certWrap">
            <div
              ref={(node) => {
                if (node) {
            ...
            >
              ...
              <div className="sg-body">
                ...
                <div className="sg-praise">
                  The learner has demonstrated strong understanding, consistency, and discipline and securing the GPA:{" "}
                  <b>{safeStr(previewCert.gpaLetter, "—")}</b> with GPA points{" "}
                  <b>
                    {previewCert.gpaPoints != null ? String(previewCert.gpaPoints) : safeStr(previewCert.gpaPoints, "—")}
                  </b>{" "}
                ...
                <div className="sg-desc">
                  This certificate is digitally generated by <b>{SYSTEM_NAME}</b> and can be verified using the Certificate
                  Number shown in the header.
                </div>
                ...
                <div className="sg-bottomRow">
                  ...
                  <div className="sg-dateBox">
                    <div className="sg-signLabel">DATE: {new Date(previewCert.issuedAt).toLocaleDateString()}</div>
                  </div>
                </div>
              </div>
          ...
          <div className="sg-modal-actions">
            <button type="button" className="btn-lite" onClick={() => setPreviewCert(null)}>
              Close
            </button>
            <button
              type="button"
